                                ...
                                <div class="pb-2 col-sm-2">
                                    ...
                                    <select id="kota" name="kota" class="form-control" onchange='if(this.value != 0) { this.form.submit(); }'>
                                        ...
                                        @foreach ($datakota as $data)
                                            <option value="{{ $data->kota_dealer }}">{{ Str::title($data->kota_dealer) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="pb-2 col">
                                            ...
                                            <form class="row" action="">
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="kota" value="{{ Str::title($data->kota_dealer) }}">
                                                    </div>
                                                </div>
                                            </form>
                                        </div>

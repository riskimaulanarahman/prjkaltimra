...
@section('title', 'User Main Dealer')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="tambahdatauser">Tambah Data User Pusat</h5>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="float-left">
                            <h5>Data User Pusat</h5>
                        </div>
                        <div class="float-right">
                            <button data-toggle="modal" data-target="#tambahdata" class="btn btn-sm btn-success">Tambah Data User Pusat <i class="cil-plus"></i></button>
                            <a href="{{ route('pusat.register') }}" target="private" class="btn btn-sm btn-warning"><i class="cil-link"></i></a>
                        </div>
                    </div>
                </div>
                <hr>
                        ...
                        <div style="text-decoration: none;">
                            <div class="card mb-2" style="border-radius: 5px; font-size: 12px">
                                <div class="row p-2 align-items-center">
                                    ...
                                    <div class="col-3">
                                        <div class="font-weight-bold" style="color: #222222">
                                            {{ $data->jabatanpusat->nama_jabatan ?? '-' }}
                                        </div>
                                    </div>
                                    <div class="col-3">
                                            ...
                                            <form class="row" action="">
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="jabatan" class="form-control">
                                                            <option value="{{ $data->jabatanpusat->id ?? '-' }}">{{ $data->jabatanpusat->nama_jabatan ?? '-' }}</option>
                                                            <option value="">---</option>
                                                            @foreach ($datajabatan as $data_j)
                                                                <option value="{{ $data_j->id }}">{{ $data_j->nama_jabatan }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="mb-3">

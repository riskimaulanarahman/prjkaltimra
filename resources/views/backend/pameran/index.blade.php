            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="float-right">
                            <a href="{{ route('frontend.user.pameran.create') }}" class="btn btn-success">Download Excel </a>
                        </div>
                    </div>
                </div>
                <hr>
                ...
                <div class="card mb-2 bg-gray-500 text-white" style="border-radius: 5px; font-size: 12px;">
                    <div class="row p-2 font-weight-bold">
                        ...
                        <div class="col-3">Pameran</div>
                        <div class="col-3">Lokasi</div>
                        <div class="col-3">Approval</div>
                    </div>
                </div>
                            ...
                            <div class="col-3">
                                ...
                                <div class="row d-none d-sm-block">
                                    ...
                                    <div class="pl-3" style="">
                                        {{-- @if ($data->status == 1) --}}
                                            {{-- <div class="badge badge-danger">Belum Membuar </div> --}}

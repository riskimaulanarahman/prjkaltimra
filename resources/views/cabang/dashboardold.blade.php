...
<script>
    ...
    series: [
        ...
        @foreach ( $datakategori as $kat_ac_1)
            @php
                $total_ac = $total_ac + $kat_ac_1->dealerfinalactivity($kat_ac_1->id, request()->lokasi, request()->dealer, request()->get('date-analisys'), request()->get('month-analisys'), request()->get('year-analisys'))->count();
            @endphp
            {
                name: "{{ $kat_ac_1->nama_kategori }}",
                type: "column",
                data: [{{ $kat_ac_1->dealerfinalactivity($kat_ac_1->id, request()->lokasi, request()->dealer, request()->get('date-analisys'), request()->get('month-analisys'), request()->get('year-analisys'))->count() }}]
            },
        @endforeach
    ],
    stroke: {
...
<script>
    ...
    series: [
        ...
        @foreach ( $datakategori as $kat_ac_2)
            @php
                $total_ab = $total_ab + $kat_ac_2->dealerakanberjalan($kat_ac_2->id, request()->lokasi, request()->dealer, request()->get('date-analisys'), request()->get('month-analisys'), request()->get('year-analisys'))->count();
                $total_sb = $total_sb + $kat_ac_2->dealersedangberjalan($kat_ac_2->id, request()->lokasi, request()->dealer, request()->get('date-analisys'), request()->get('month-analisys'), request()->get('year-analisys'))->count();
                $total_s  = $total_s + $kat_ac_2->dealerselesai($kat_ac_2->id, request()->lokasi, request()->dealer, request()->get('date-analisys'), request()->get('month-analisys'), request()->get('year-analisys'))->count();
            @endphp

                {
                    ...
                    type: "column",
                    data: [
                            {{ $kat_ac_2->dealerakanberjalan($kat_ac_2->id, request()->lokasi, request()->dealer, request()->get('date-analisys'), request()->get('month-analisys'), request()->get('year-analisys'))->count() }},
                            {{ $kat_ac_2->dealersedangberjalan($kat_ac_2->id, request()->lokasi, request()->dealer, request()->get('date-analisys'), request()->get('month-analisys'), request()->get('year-analisys'))->count() }},
                            {{ $kat_ac_2->dealerselesai($kat_ac_2->id, request()->lokasi, request()->dealer, request()->get('date-analisys'), request()->get('month-analisys'), request()->get('year-analisys'))->count() }}
                    ]
                },
        @endforeach
    ],
        ...
        @foreach ($datakategori as $kat_ac_1)
            {
                ...
                data: [
                    @foreach ($datadealer as $dealer_)
                        {{ $kat_ac_1->dealerfinalactivitydealer($kat_ac_1->id, $dealer_->id, request()->get('date-analisys'), request()->get('month-analisys'), request()->get('year-analisys'))->count() }},
                    @endforeach
                ]
            },
        @endforeach
    ...
    xaxis: {
        categories: [
            @foreach ($datadealer as $dealer_)
                ...
                @foreach ($datakategori as $kat_ac_1)
                    @php
                        $total_ac_dealer = $total_ac_dealer + $kat_ac_1->dealerfinalactivitydealer($kat_ac_1->id, $dealer_->id, request()->get('date-analisys'), request()->get('month-analisys'), request()->get('year-analisys'))->count();
                    @endphp
                @endforeach
        ...
        @foreach ($datakategori as $kat_ac_1)
            {
                ...
                data: [
                    @foreach ($datalokasikota as $kota)
                        {{ $kat_ac_1->dealerfinalactivitykota($kat_ac_1->id, $kota->kota_lokasi, request()->get('date-analisys'), request()->get('month-analisys'), request()->get('year-analisys'))->count() }},
                    @endforeach
                ]
            },
        @endforeach
    ...
    xaxis: {
        categories: [
            @foreach ($datalokasikota as $kota)
                ...
                @foreach ($datakategori as $kat_ac_1)
                    @php
                        $total_ac_kota = $total_ac_kota + $kat_ac_1->dealerfinalactivitykota($kat_ac_1->id, $kota->kota_lokasi, request()->get('date-analisys'), request()->get('month-analisys'), request()->get('year-analisys'))->count();
                    @endphp
                @endforeach
                ...
                data: [
                    @foreach ($datakategori as $kat_ac_3_a)
                        @php
                            $target = 0;
                        @endphp
                        @foreach ($kat_ac_3_a->dealerfinalactivity($kat_ac_3_a->id, request()->lokasi, request()->dealer)->get() as $target_lpj_a)
                            @php
                ...
                data: [
                    @foreach ($datakategori as $kat_ac_3_b)
                        @php
                            $target = 0;
                        @endphp
                        @foreach ($kat_ac_3_b->dealerfinalactivity($kat_ac_3_b->id, request()->lokasi, request()->dealer, request()->get('date-analisys'), request()->get('month-analisys'), request()->get('year-analisys'))->get() as $target_lpj_a)
                            @php
                ...
                data: [
                    @foreach ($datakategori as $kat_ac_3_c)
                        @php
                            $target = 0;
                        @endphp
                        @foreach ($kat_ac_3_c->dealerfinalactivity($kat_ac_3_c->id, request()->lokasi, request()->dealer, request()->get('date-analisys'), request()->get('month-analisys'), request()->get('year-analisys'))->get() as $target_lpj_a)
                            @php
                ...
                data: [
                    @foreach ($datakategori as $kat_ac_3_d)
                        @php
                            $target = 0;
                        @endphp
                        @foreach ($kat_ac_3_d->dealerfinalactivity($kat_ac_3_d->id, request()->lokasi, request()->dealer, request()->get('date-analisys'), request()->get('month-analisys'), request()->get('year-analisys'))->get() as $target_lpj_a)
                            @php

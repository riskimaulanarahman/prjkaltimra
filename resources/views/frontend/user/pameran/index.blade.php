                                ...
                                <div class="row p-2">
                                    <div class="col-12 col-sm-3">
                                        ...
                                        <div class="row d-none d-sm-block">
                                            ...
                                            <div class="pl-3" style="">
                                                {{-- @if ($data->status == 1) --}}
                                                    <div class="btn btn-sm btn-outline-info" style="line-height: 0.4; font-size:10px">DRAFT</div>
                                                {{-- @elseif ($data->status == 2) --}}
                                                    {{-- <div class="badge badge-warning" style="color: black">Menuggu Persetujuan</div> --}}
                                    ...
                                    <div class="col-6 col-sm-5">
                                        <div class="font-weight-bold" style="color: #ec1b25">
                                            No: 07/704-MK/07/2021 | PAMERAN SEPAKU
                                        </div>
                                        <div class="text-muted">
                                            HARAPAN UTAMA PETUNG | Andi
                                        </div>
                                    </div>
                                ...
                                <div class="row p-2">
                                    <div class="col-12 col-sm-3">
                                        ...
                                        <div class="row d-none d-sm-block">
                                            ...
                                            <div class="pl-3" style="">
                                                {{-- @if ($data->status == 1) --}}
                                                    <div class="badge badge-danger">Ditolak / Revisi</div>
                                                {{-- @elseif ($data->status == 2) --}}
                                                    {{-- <div class="badge badge-warning" style="color: black">Menuggu Persetujuan</div> --}}
                                                {{-- @elseif ($data->status == 3) --}}
                                                    {{-- <div class="badge badge-success">Aktif</div> --}}
                                    ...
                                    <div class="col-6 col-sm-5">
                                        <div class="font-weight-bold" style="color: #ec1b25">
                                            No: 02/704-MK/05/2021 | PAMERAN SEPAKU
                                        </div>
                                        <div class="text-muted">
                                            HARAPAN UTAMA PETUNG | Eko
                                        </div>
                                    </div>
                                    <div class="col-6 col-sm-4">
                                        <div class="font-weight-bold" style="color: #222222">

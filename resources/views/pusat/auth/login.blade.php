    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card-group" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius: 0px !important; margin-top: 200px">
                <div class="card-header" style="background-color: #cf1418; border-radius: 0px !important">
                    <center>
                ...
                <div class="card p-4" style="border-radius: 0px !important">
                    <div class="card-body">
                        <h2>Main Dealer</h2>
                        <form action="{{ route('pusat.login') }}" method="post">
                            @csrf
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('pusat.login') }}" aria-label="{{ __('Login') }}">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (Route::has('pusat.password.request'))
                                    <a class="btn btn-link" href="{{ route('pusat.password.request') }}">
                                        Lupa Password ?
                                    </a>
                                @endif
                            </div>

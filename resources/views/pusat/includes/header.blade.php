    ...
    <ul class="c-header-nav ml-auto mr-4">
        <li class="c-header-nav-item dropdown">
            <x-utils.link class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                <x-slot name="text">
                    <div class="c-avatar">
                        <img class="c-avatar-img" src="https://ui-avatars.com/api/?background=random&name={{ Auth::guard('pusat')->user()->name }}" alt="{{  Auth::guard('pusat')->user()->name }}">
                    </div>
                </x-slot>
            </x-utils.link>
            ...
            <div class="dropdown-menu dropdown-menu-right pt-0">
                ...
                <x-utils.link
                    ...
                    <x-slot name="text">
                        @lang('Logout')
                        <x-forms.post :action="route('pusat.logout')" id="logout-form" class="d-none" />
                    </x-slot>
                </x-utils.link>
            </div>
        </li>

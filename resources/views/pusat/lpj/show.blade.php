                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-body">
                            ...
                            {{-- {{Auth::guard('pusat')->user()->id}} --}}
                            <input type="hidden" id="userid" value="{{Auth::guard('pusat')->user()->id}}">
                            @if($isme == 1)

                                <div class="row border-top">
                                    <div class="col-12 mb-4">
                                        <div class="mt-2 row">
                                            <label class="col-sm-2 col-form-label">Approval Action:</label>
                                            <div class="col-10">
                                                <select class="form-control" name="approvalaction" id="approvalaction">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-10">
                                                <textarea class="form-control" name="keterangan_approval" id="keterangan_approval" cols="30" rows="5"></textarea>
                                            </div>
                                        </div>
                                        <div>
                                            <button class="btn btn-xs btn-success" type="button" id="btnactionapproval" style="margin-top:10px; float:right;">Submit</button>
                                        </div>
                                    </div>
                                </div>
                            @endif
...
>>>>>>> 3c3252d (revisi done)
                                                    ...
                                                    @foreach ($dataapproval as $data_h)
                                                        <tr>
                                                            <td>{{ $n++ }}</td>
                                                            <td>
                                                                @if ($data_h->status_approval != null)
                                                                    {{ $data_h->updated_at }}
                                                                @endif
                                                            </td>
...
$(document).ready( function () {
    ...
    $('#btnactionapproval').on('click',function(){

        
        var status_approval = $('#approvalaction').val();
        var userid = $('#userid').val();
        var keterangan_approval = $('#keterangan_approval').val();
        var id = $('input[name="id"]').val();

        if (!status_approval) {
            alert("Status approval tidak boleh kosong");
        ...
        $.ajax({
            url: '/main/updatelpjapproval',
            type: 'POST',
            data: {id: id,status_approval: status_approval,keterangan_approval:keterangan_approval,userid:userid,_token: $('input[name="_token"]').val()},

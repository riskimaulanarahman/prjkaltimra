...
/>
                    ...
                    <form class="card-body" action="{{ route('pusat.proposal.postStore') }}" method="POST">
                        ...
                        <div class="mb-2 row">
                            <label class="col-sm-2 col-form-label">
                                <strong>Dealer<strong style="color:rgb(243, 0, 0)">*</strong></strong>
                            </label>
    ...
    @php
        $lat_  = $kota->titikmap->latitude ?? '0.8570910572617';
        $long_ = $kota->titikmap->longtitude ?? '116.51285424828';
        $zoom_ = $kota->titikmap->zoom ?? 7;
    @endphp
    <script>

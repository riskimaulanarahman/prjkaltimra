...
<div class="row">
    <div class="col-12">
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            ...
            <div>
                Halaman Inbox ini akan dialihkan ke halaman Inbox Yang Baru.
            </div>
            <div>
                Apabila masih terdapat data di halaman ini. Mohon di Selesaikan terlebih dahulu proses Approvalnya. Terima Kasih.
            </div>
                                ...
                                <div style="text-decoration: none;">
                                    <div class="card mb-2" style="border-radius: 5px; font-size: 12px">
                                        <div class="row p-2 align-items-center">
                                            ...
                                            <div class="col p-0 pr-4 text-right">
